...
AUDITOR_INSTANCE = "GPT-FRESH-COV-T1-E"
DATE = "2026-08-17"
OUT = Path("audits/remediation/2026-08-17")
FREEZE_BRANCH = "freeze/pre-batch3-legacy-salvage-t1-r2-v1"
...
def main() -> int:
    ...
    blind = {
        ...
        "content_boundary": "Intentionally excludes keyed answers, explanations, rule/drug links, family metadata, lifecycle fields, prior audit conclusions, adjudication reasoning, and repair rationale so the auditor can solve independently first.",
    }

    OUT.mkdir(parents=True, exist_ok=True)
    blind_path = OUT / "GPT-E-BLIND-QUESTIONS-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
    ...
    common = {
        ...
        "content_boundary": "No question text, keyed answers, explanations, family metadata, prior audit conclusions, adjudication reasoning, or repair rationale are embedded in this contract package. Use the blind package for independent solving and verify canonical hashes mechanically.",
        "independence_note": "Independently solve all four questions before inspecting keyed answers, explanations, prior review material, repository conclusions, repair history, or prior versions. Current-law decisions must be based on independently researched official sources.",
    }
    ...
    legal_path = OUT / "GPT-E-LEGAL-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
    realism_path = OUT / "GPT-E-REALISM-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
    ...
    manifest = {
        "manifest_type": "PRE_BATCH3_LEGACY_SALVAGE_T1_R2_CLEAN_FREEZE_V1",
        "created_date": DATE,
    ...
    manifest_path = OUT / "PRE-BATCH3-LEGACY-SALVAGE-T1-R2-CLEAN-FREEZE-V1-MANIFEST.json"
