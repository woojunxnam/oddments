...
from freeze_legacy_salvage_t1_r2_v3 import AUDITOR_INSTANCE, CANDIDATE_SHA, QUESTION_IDS, index
...
BLIND_PATH = ROOT / "GPT-G-BLIND-QUESTIONS-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
LEGAL_PATH = ROOT / "GPT-G-LEGAL-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
REALISM_PATH = ROOT / "GPT-G-REALISM-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
MANIFEST_PATH = ROOT / "PRE-BATCH3-LEGACY-SALVAGE-T1-R2-CLEAN-FREEZE-V3-MANIFEST.json"
...
def main() -> int:
    ...
    assert manifest["supersedes_contaminated_audit_issue"] == 61
    assert manifest["phase0_no_canonical_content_access"] is True
    ...
    assert {qid: question_audit_hash(questions[qid]) for qid in QUESTION_IDS} == manifest["question_hashes"]
    ...
    print("sanitized T1 r2 v3 changed-item freeze mechanical verification: PASS")
