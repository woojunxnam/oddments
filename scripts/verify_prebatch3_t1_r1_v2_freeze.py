...
from freeze_legacy_salvage_t1_r1_v2 import AUDITOR_INSTANCE, CANDIDATE_SHA, QUESTION_IDS, index
...
BLIND_PATH = ROOT / "GPT-D-BLIND-QUESTIONS-PRE-BATCH3-LEGACY-SALVAGE-T1-R1.json"
LEGAL_PATH = ROOT / "GPT-D-LEGAL-PRE-BATCH3-LEGACY-SALVAGE-T1-R1.json"
REALISM_PATH = ROOT / "GPT-D-REALISM-PRE-BATCH3-LEGACY-SALVAGE-T1-R1.json"
MANIFEST_PATH = ROOT / "PRE-BATCH3-LEGACY-SALVAGE-T1-R1-CLEAN-FREEZE-V2-MANIFEST.json"
...
def main() -> int:
    ...
    assert manifest["supersedes_incomplete_audit_issue"] == 53
    ...
    print("sanitized T1 r1 v2 changed-item freeze mechanical verification: PASS")
