...
from freeze_legacy_salvage_t1_v2 import AUDITOR_INSTANCE, CANDIDATE_SHA, QUESTION_IDS, index
...
BLIND_PATH = ROOT / "GPT-B-BLIND-QUESTIONS-PRE-BATCH3-LEGACY-SALVAGE-T1.json"
LEGAL_PATH = ROOT / "GPT-B-LEGAL-PRE-BATCH3-LEGACY-SALVAGE-T1.json"
REALISM_PATH = ROOT / "GPT-B-REALISM-PRE-BATCH3-LEGACY-SALVAGE-T1.json"
MANIFEST_PATH = ROOT / "PRE-BATCH3-LEGACY-SALVAGE-T1-CLEAN-FREEZE-V2-MANIFEST.json"
...
def main() -> int:
    ...
    print("sanitized T1 v2 freeze mechanical verification: PASS")
