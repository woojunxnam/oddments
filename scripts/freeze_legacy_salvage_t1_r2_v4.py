...
AUDITOR_INSTANCE = "GPT-FRESH-COV-T1-H"
DATE = "2026-08-18"
OUT = Path("audits/remediation/2026-08-18")
FREEZE_BRANCH = "freeze/pre-batch3-legacy-salvage-t1-r2-v4"
...
def main() -> int:
    ...
    blind = {
        ...
        "content_boundary": "Contains only frozen question ID/type/stem/choices. Excludes keyed answers, explanations, rule/drug links, family/lifecycle/audit metadata, prior conclusions, repair rationale, and previous auditor-session output.",
    }

    OUT.mkdir(parents=True, exist_ok=True)
    blind_path = OUT / "GPT-H-BLIND-QUESTIONS-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
    ...
    common = {
        ...
        "content_boundary": "No question text, keyed answers, explanations, family metadata, prior conclusions, repair rationale, or previous auditor-session output are embedded in this contract package.",
        "independence_note": "Governance mechanically pre-certifies Phase 0. Auditor H begins at blind Phase 1 and must lock all four decisions before canonical answer/explanation access.",
    }
    ...
    realism = {
        **common,
        ...
        "style_profile": dependency_snapshots["style_profile"],
        "result_contract": {
            "required_fields": [
                "Question_ID",
                "Verdict",
    ...
    legal_path = OUT / "GPT-H-LEGAL-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
    realism_path = OUT / "GPT-H-REALISM-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
    ...
    manifest = {
        "manifest_type": "PRE_BATCH3_LEGACY_SALVAGE_T1_R2_CLEAN_FREEZE_V4",
        "created_date": DATE,
        ...
        "phase0_execution_owner": "GOVERNANCE",
        "auditor_phase0_required": False,
        "supersedes_env_blocked_issue": 62,
        "locked_next_step": "Governance-attested mechanical gate, then fresh Auditor H begins directly with blind Phase 1, followed by LEGAL_VERIFICATION and FULL-bank REALISM_REVIEW for Q0079/Q0082/Q0083/Q0084.",
    }

    manifest_path = OUT / "PRE-BATCH3-LEGACY-SALVAGE-T1-R2-CLEAN-FREEZE-V4-MANIFEST.json"
