...
def run(cfg: dict) -> tuple[Check, dict]:
    ...
    lock_state = {
        ...
        "declared_question_count": lock.get("question_count"),
        "freeze_head_expected": lock.get("freeze_head_expected"),
        "freeze_head_observed": lock.get("freeze_head_observed"),
        "blind_package_sha256": lock.get("blind_package_sha256"),
    }
