...
from freeze_legacy_salvage_t1_r2_v2 import AUDITOR_INSTANCE, CANDIDATE_SHA, QUESTION_IDS, index
...
BLIND_PATH = ROOT / "GPT-F-BLIND-QUESTIONS-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
LEGAL_PATH = ROOT / "GPT-F-LEGAL-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
REALISM_PATH = ROOT / "GPT-F-REALISM-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
MANIFEST_PATH = ROOT / "PRE-BATCH3-LEGACY-SALVAGE-T1-R2-CLEAN-FREEZE-V2-MANIFEST.json"
...
def main() -> int:
    ...
    assert manifest["supersedes_contaminated_audit_issue"] == 60
    ...
    print("sanitized T1 r2 v2 changed-item freeze mechanical verification: PASS")
