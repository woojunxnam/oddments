...
def main() -> int:
    ...
    # Q0075: add a distinct, plainly technical task so the correct-count pattern is not concentrated at two.
    update_question(
        75,
        choices=[
        ...
        core_reasoning="A technician trainee may perform authorized clerical and technical support functions under the required direct pharmacist supervision, but may not independently counsel, resolve a clinical DUR problem, or perform final pharmacist verification. The clinical question and unresolved alert therefore go to the pharmacist while ordinary nonclinical trainee work may continue.",
    )

    # Q0078: distinguish separate education documentation from internship credit; three statements are independently true.
    update_question(
        78,
        choices=[
        ...
        choice_analysis={
            ...
            "D": "Incorrect. This rule specifically limits pharmacy internship credit.",
            "E": "Incorrect. Signatures on separate records cannot waive the daily internship-credit ceiling."
        },
        core_reasoning="The question concerns credit toward the Massachusetts pharmacy internship, not whether a student may be present for separate educational activity. Board internship credit is capped at 12 hours in one day. The preceptor therefore records at most 12 internship hours; a separate seminar can be documented for school purposes without increasing the Board internship credit.",
    )
    ...
    print("structural polish applied to Q0040/Q0075/Q0078/Q0087")
    return 0
