...
from freeze_legacy_salvage_t1_r2_v4 import AUDITOR_INSTANCE, CANDIDATE_SHA, QUESTION_IDS, index
...
BLIND_PATH = ROOT / "GPT-H-BLIND-QUESTIONS-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
LEGAL_PATH = ROOT / "GPT-H-LEGAL-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
REALISM_PATH = ROOT / "GPT-H-REALISM-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
...
def main() -> int:
    ...
    assert manifest["phase0_execution_owner"] == "GOVERNANCE"
    assert manifest["auditor_phase0_required"] is False
    assert manifest["supersedes_env_blocked_issue"] == 62
    ...
    print("governance-attested T1 r2 v4 mechanical verification: PASS")
