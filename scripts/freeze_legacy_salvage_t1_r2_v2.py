...
AUDITOR_INSTANCE = "GPT-FRESH-COV-T1-F"
DATE = "2026-08-18"
OUT = Path("audits/remediation/2026-08-18")
FREEZE_BRANCH = "freeze/pre-batch3-legacy-salvage-t1-r2-v2"
...
def main() -> int:
    ...
    blind = {
        ...
        "content_boundary": "Intentionally excludes keyed answers, explanations, rule/drug links, family metadata, lifecycle fields, prior audit conclusions, adjudication reasoning, repair rationale, and all prior auditor-session conclusions so the auditor can solve independently first.",
    }

    OUT.mkdir(parents=True, exist_ok=True)
    blind_path = OUT / "GPT-F-BLIND-QUESTIONS-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
    ...
    common = {
        ...
        "content_boundary": "No question text, keyed answers, explanations, family metadata, prior audit conclusions, adjudication reasoning, repair rationale, or prior auditor-session conclusions are embedded in this contract package. Use the blind package for independent solving and verify canonical hashes mechanically.",
        "independence_note": "Independently solve all four questions before inspecting keyed answers, explanations, prior review material, repository conclusions, repair history, prior versions, or any earlier auditor-session output. Current-law decisions must be based on independently researched official sources.",
    }
    ...
    legal_path = OUT / "GPT-F-LEGAL-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
    realism_path = OUT / "GPT-F-REALISM-PRE-BATCH3-LEGACY-SALVAGE-T1-R2.json"
    ...
    manifest = {
        "manifest_type": "PRE_BATCH3_LEGACY_SALVAGE_T1_R2_CLEAN_FREEZE_V2",
        "created_date": DATE,
        ...
        "supersedes_contaminated_audit_issue": 60,
        "locked_next_step": "Fresh independent REAUDIT LEGAL_VERIFICATION + FULL-bank REALISM_REVIEW of exactly MA-Q-0079, MA-Q-0082, MA-Q-0083, and MA-Q-0084 before guarded T1 admission can resume.",
    }

    manifest_path = OUT / "PRE-BATCH3-LEGACY-SALVAGE-T1-R2-CLEAN-FREEZE-V2-MANIFEST.json"
